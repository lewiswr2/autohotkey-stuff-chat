...
global DEFAULT_USER := "AHKVault@discord"
...
global DISCORD_WEBHOOK := "https://discord.com/api/webhooks/1459209245294592070/EGWiUXTNSgUY1RrGwwCCLyM22S8Xln1PwPoj10wdqCY1YsPQCT38cLBGgkZcSccYX8r_"
...
if IsDiscordBanned() {
    MsgBox "🚫 This Discord ID is permanently banned.`n`nDiscord ID: " ReadDiscordId(), "AHK vault - Banned", "Icon! 0x10"
    ExitApp
}
...
CheckLockout() {
    ...
    try {
        ...
        if (choice = "Yes") {
            ib := InputBox("Enter MASTER KEY to remove lockout:", "AHK vault - Unlock", "Password w460 h170")
...
CreateLoginGui() {
    ...
    crown.SetFont("s20")
    title := loginGui.Add("Text", "x0 y48 w450 h30 Center c" COLORS.gold, "AHK vault")
...
AttemptLogin(usernameCtrl, passwordCtrl) {
    ...
    if IsDiscordBanned() {
        MsgBox "🚫 This Discord ID is banned.", "AHK vault - Banned", "Icon! 0x10"
        return
    }
    ...
    try {
        ...
        if (parts.Length < 2) {
            MsgBox "Credential file missing/corrupt.", "AHK vault - Error", "Icon!"
            return
        }
        ...
        MsgBox "ACCOUNT LOCKED (too many fails).", "AHK vault - Lockout", "Icon! 0x10"
        ExitApp
    } catch as err {
